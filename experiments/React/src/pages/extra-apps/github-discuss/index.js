...
class ExtraAppsGithubDiscuss extends React.Component {
  render() {
    return (
      <div>
        ...
        <div className="row">
            ...
            <div className="d-flex align-items-start mb-3">
              ...
              <div className="card flex-grow-1">
                ...
                <div className="card-body">
                  <h3>Description</h3>
                  <p>
                    Added child elements to the active text editor lose their scrollTop property
                    when they are scrolled out of view.
                  </p>
                  <p>
                  ...
                  <p>
                    If you scroll inside of the element and then scroll down the text editor for it
                    to fall out of view and be temporarily removed from the DOM. If you scroll back
                    up that scroll position inside the element is lost.
                  </p>
                  <h3>Steps to Reproduce</h3>
                  <ol>
                    <li>Have hydrogen active and setup properly</li>
                    <li>
                      Use <code>Run Cell</code> command from hydrogen on the code below with about
                      50 extra new lines
                    </li>
                  </ol>
                  <pre>
                  ...
                  <p>
                    <strong>Actual behavior:</strong> Scroll top of the result view has been set to
                    0 upon removal and adding back to the active DOM
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    <code>atom --version</code> and <code>apm --version</code> from the command
                    line. Also, please include the OS and what version of the OS you&apos;re
                    running.
                  </p>
                  <p>
                    Atom : 1.37.0
                  ...
                  <p>
                    This isn&apos;t platform specific either, and I don&apos;t believe its a
                    hydrogen problem.
          ...
          <div className="col-lg-3">
            ...
            <div className="py-4">
              ...
              <div className="air__utils__avatarGroup mb-3">
                <div className="air__utils__avatar air__utils__avatar--size46">
