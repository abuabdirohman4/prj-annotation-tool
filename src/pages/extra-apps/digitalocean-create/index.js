...
class ExtraAppsDigitaloceanCreate extends React.Component {
  render() {
    return (
      <div>
        ...
        <div className="d-flex flex-wrap mb-5">
          ...
          <div className="card width-200 text-center mr-5 bg-gray-1 border-blue">
            <div className="card-header pt-3 pb-3">
        ...
        <p className="mb-4">
          Block storage lets you add independent storage volumes that can be accessed like local
          disk and moved from one Droplet to another within the same region.
        </p>
        <a
