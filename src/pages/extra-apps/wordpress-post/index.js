          ...
          <div className="col-xl-9 col-lg-12">
            ...
            <div className="card">
              <div className="card-body">
                ...
                <General15 />
                <a href="javascript: void(0);" className="d-block btn btn-light text-primary mt-3">
                  Load More
                </a>
              </div>
            </div>
            <div className="card">
              <div className="card-body">
                <div className="d-flex align-items-center flex-wrap border-bottom mb-3 pb-3">
                  <div className="air__utils__avatar air__utils__avatar--size110 mr-3 mb-3 align-items-center flex-shrink-0">
