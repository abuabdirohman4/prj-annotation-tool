...
class AdvancedEmailTemplates extends React.Component {
  render() {
    return (
      <div>
        <Helmet title="Advanced: Email Templates" />
        <div className="air__utils__heading">
          <h5>Advanced: Email Templates</h5>
        </div>
        <div className="row">
                    ...
                    <tbody>
                      <tr>
                        <td style={{ verticalAlign: 'top' }}>
                          <img
                            src="resources/images/air-logo-large.png"
                            alt="Air UI Admin Template"
                            style={{ height: '40px' }}
                          />
                        </td>
                      ...
                      <tbody>
                        <tr>
                          <td>
                            ...
                            <p>
                              This is a really simple email template. It&apos;s sole purpose is to
                              get the recipient to click the button with no distractions.
                            </p>
                      ...
                      <tbody>
                        <tr>
                          <td>
                            ...
                            <p>
                              Seems like you forgot your password for Air UI. If this is true, click
